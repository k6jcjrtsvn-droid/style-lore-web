...
foreach ($rows as $r) {
    ...
    $body =
        '<p style="margin:0 0 14px;">Hi ' . htmlspecialchars($hi) . ' — I\'m Jayne. I built Style-LORE, and you took the quiz a little while back.</p>'
    ...
    $text = "Hi $hi — I'm Jayne. I built Style-LORE, and you took the quiz a little while back.\n\n"
